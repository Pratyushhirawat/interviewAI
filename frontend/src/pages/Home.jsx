    ...
    <div className='bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden'>
        ...
        className='fixed top-0 left-0 right-0 z-50 h-13 flex items-center justify-between px-5 bg-white/70 backdrop-blur-xl border-b border-black/5'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <span className='font-extrabold text-base tracking-tight text-[#0A0A0A]'>InterviewAI</span>
            </div>
            ...
            whileTap={{ scale: 0.97 }}
            className='bg-[#0A0A0A]/80 backdrop-blur-2xl text-white font-semibold border border-white/10 rounded-md px-3 py-1.5 text-xs cursor-pointer transition-all flex items-center gap-2 hover:border-white/20 shadow-[0_8px_24px_rgba(0,0,0,0.25)]'>
                Login <FaArrowRight />
            </motion.button>
        ...
        <section className='relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]'>
            <div className='absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 rounded-full bg-black/4 blur-[90px] pointer-events-none' />
            ...
            <div className='max-w-4xl mx-auto px-6 text-center'>
                ...
                className='text-3xl md:text-5xl font-extrabold leading-[1.1] tracking-tight mb-4 text-[#0A0A0A] [text-shadow:0_4px_24px_rgba(0,0,0,0.12)]'>
                    Job Interviews <br />
                    <span className='text-black/30'>Don't have to Suck</span><br />Anymore!
                ...
                className='text-black/45 text-sm leading-relaxed max-w-md mx-auto mb-6 [text-shadow:0_2px_10px_rgba(0,0,0,0.06)]'>
                    Interview.AI is an innovative AI-powered interview preperation platform designed to help job seekers excel in their interviews.
                ...
                transition={{ duration: 0.55, delay: 0.28 }}>
                    ...
                    className='relative overflow-hidden bg-[#0A0A0A]/80 backdrop-blur-2xl text-white font-bold px-5 py-2.5 rounded-lg text-xs cursor-pointer border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all hover:border-white/20'>
                        ...
                        <span className='absolute inset-0 bg-linear-to-br from-white/1 via-transparent to-transparent pointer-events-none rounded-lg'/>
                    </motion.button>
                </motion.div>
            </div>
            ...
            <div className='max-w-5xl mx-auto px-6'>
                <div className='text-center mb-10'>
                    ...
                    <h2 className='text-2xl md:text-4xl font-extrabold tracking-tight text-[#0A0A0A] [text-shadow:0_4px_20px_rgba(0,0,0,0.1)]'>
                        Specialized Agents For <span className='block text-black/30'>Every Interview Stage</span>
                    </h2>

                    <p className='text-black/40 text-sm max-w-2xl mx-auto mt-4 leading-relaxed'>
                    Interview.AI combines multiple AI Agents that work together to help you build your resume, practice interviews, receive detailed feedback, and follow a personalized roadmap to land your dream job.
                    </p>
                </div>
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    {
                        [
                            ...
                            },
                            {
                                ...
                                desc: "Conduct realistic FR, Technical and Coding interview with AI-powered simulations."
                            },
                            {
                                icon: <FiBarChart2 />,
        ...
        {showLogin && <LoginModel onClose={()=>setShowLogin(false)} setUser={setUser} />}
                ...
                <footer className='border-t border-black/7 py-6 text-center bg-white'>
                    <div className='flex items-center justify-center gap-2 mb-1.5'>
                        ...
                        <span className='font-bold text-xs text-[#0A0A0A]/70'>InterviewAI</span>
                    </div>
