...
const LANG_OPTIONS= ["python", "java", "javascript", "cpp"]
                    ...
                    className='fixed inset-x-3 top-4 bottom-4 sm:inset-x-6 sm:top-6 sm:bottom-6 md:inset-x-10 md:top-8 md:bottom-8 z-50 flex flex-col overflow-hidden rounded-2xl bg-[#0E1016] border border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.5)]'>
                        ...
                        <div className='flex items-center gap-1.5 mx-auto'>
                            {LANG_OPTIONS.map((l)=>(
                                ...
                                }} key={l} className={`text-xs px-2.5 py-1 rounded-lg capitalize transition-all cursor-pointer ${
                                    lang == l
                        ...
                        <button onClick={onClose} className='text-white/35 hover:text-white transition-colors cursor-pointer'>
                        <FiX size={18} />
                        </button>
                        </div>
                        ...
                        <div className='relative flex-1 min-h-0'>
                            ...
                            options={{
                                ...
                                wordWrap: "on",
                                padding: { top: 12 },
                                fontFamily: " 'Fira Code', 'Casadia Code', monospace",
                                fontLigatures: true,
                        ...
                        <button onClick={()=>onSubmitCode?.(code)} className='flex items-center gap-1.5 text-xs px-4 py-2 rounded-lg bg-white text-[#0A0A0A] font-semibold hover:bg-white/90 transition-all cursor-pointer'>Add Answer
