...
import { submitAnswer } from '../../apis/interviewApi'
...
function Step2Interview({ interviewData, user }) {
  ...
  const handleSubmitCode = async (code) => {
    setAnswer((prev)=>{
      const seperator = prev.trim() ? "\n\n --- Code --- \n" : "--- Code ---\n"
      return prev + seperator + code
    });
    setCodeOpen(false)
  }
  ...
  return (
    <div className='min-h-screen bg-white flex items-center justify-center p-3 sm:p-5'>
      ...
      {codeOpen && <CodeEditor onClose={()=>setCodeOpen(false)} onSubmitCode={handleSubmitCode} />}
        ...
        className='w-full max-w-5xl bg-[#0E1016] border border-white/10 rounded-2xl sm:rounded-3xl overflow-hidden grid lg:grid-cols-[36%_64%] shadow-[0_0_60px_rgba(255,255,255,0.03)]'>
          ...
          <div className='flex flex-col items-center gap-1.5 pt-1'>
              <div className='flex items-center justify-center gap-3'>
                ...
                className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-all ${
                  showMicOn ? "bg-white/10 border-white/15 text-white"
                  : "bg-red-500/20 border-red-500/30 text-red-400"
                }`}>
                  {showMicOn ?
                <FiMic size={15} /> : <FiMicOff size={15} />  
                }
                ...
                whileTap={{ scale: 0.93 }}
                className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-all ${
                  cameraOn ? "bg-white/10 border-white/15 text-white"
                  : "bg-white/5 border-white/10 text-white/45 hover:text-white/70"
                }`}>
                  {cameraOn ?
                <FiCamera size={15} /> : <FiCameraOff size={15} />  
                }
              ...
              Coding question? Use <FiCode size={9} className='inline -mt-0.5' /> to write &amp; add code</span>
          </div>
          ...
          <div className='flex flex-col p-4 sm:p-6'>
                  <div className='flex items-start justify-between mb-4'>
                    ...
                    <div className='flex flex-col items-end gap-1.5 min-w-27.5'>
                  ...
                  <div className='flex-1 flex flex-col min-h-0'>
                    ...
                    placeholder='Write your answer here... oe speak if mic is on'
                  ...
                  className='ml-auto h-10 min-w-37.5 justify-center px-5 rounded-xl bg-white text-black text-sm font-semibold flex items-center gap-2 disabled:opacity-40 transition'>
